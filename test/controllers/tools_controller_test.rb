...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { description: @tool.description, file: @tool.file, title: @tool.title } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { description: @tool.description, file: @tool.file, title: @tool.title } }
